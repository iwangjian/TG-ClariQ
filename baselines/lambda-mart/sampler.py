...
class NegativeSampler():
    """
    Sample candidates from a list of candidates.
    Args:
    ...
    def random_sample(self, relevant_doc):
        """
    ...
    def hierachi_sample(self, relevant_doc):
        """
    ...
    def sample(self, relevant_doc):
        if self.task == 'ts':
            return self.random_sample(relevant_doc)
        else:
            return self.hierachi_sample(relevant_doc)
